 ...
 */
@Entity
@Table(name = "prioridad", schema = "public")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Prioridad.findByNombreLike", query = "SELECT m FROM Prioridad m WHERE LOWER(m.nombre) LIKE CONCAT('%',LOWER(:nombre),'%') ")
...
public class Prioridad implements Serializable {
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.tpi135_2018.mantenimiento.entidades.Prioridad[ idPrioridad=" + idPrioridad + " ]";
    }
